...
public class brickslandru_prideDemysexual{

    public brickslandru_prideDemysexual(){}

    public static BlockPrideDemysexual block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideDemysexual");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('2'), new ItemStack(Items.dye, 1, 8),
            Character.valueOf('3'), new ItemStack(Items.dye, 1, 0),
            Character.valueOf('4'), new ItemStack(Items.dye, 1, 5),
    ...
    static{
        ...
        block = (BlockPrideDemysexual)(new BlockPrideDemysexual().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideDemysexual")
                .setBlockTextureName("PrideDemysexual")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideDemysexual", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideDemysexual extends Block
    {
        ...
        protected BlockPrideDemysexual()
        {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideDemysexualDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideDemysexualRight");
