...
public class brickslandru_prideLgbt {

    public brickslandru_prideLgbt(){}

    public static BlockPrideLgbt block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideLgbt");
    }
    ...
    static{
        ...
        block = (BlockPrideLgbt)(new BlockPrideLgbt().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideLgbt")
                .setBlockTextureName("PrideLgbt")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideLgbt", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideLgbt extends Block
    {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideGayDown");
            this.BlockIconLeft = par1IconRegister.registerIcon("PrideGayLeft");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideGayRight");
