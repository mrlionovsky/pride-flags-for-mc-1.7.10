...
public class brickslandru_prideHeterosexual{

    public brickslandru_prideHeterosexual(){}

    public static BlockPrideHeterosexual block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideHeterosexual");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('3'), new ItemStack(Items.dye, 1, 8),
            Character.valueOf('4'), new ItemStack(Items.dye, 1, 15),
    ...
    static{
        ...
        block = (BlockPrideHeterosexual)(new BlockPrideHeterosexual().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideHeterosexual")
                .setBlockTextureName("PrideHeterosexual")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideHeterosexual", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideHeterosexual extends Block
    {
        ...
        protected BlockPrideHeterosexual()
        {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideHeterosexualDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideHeterosexualRight");
