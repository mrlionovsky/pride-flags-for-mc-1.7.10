...
public class brickslandru_prideBisexual{

    public brickslandru_prideBisexual(){}

    public static BlockPrideBisexual block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideBisexual");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('2'), new ItemStack(Items.dye, 1, 5),
            Character.valueOf('3'), new ItemStack(Items.dye, 1, 13),
    ...
    static{
        ...
        block = (BlockPrideBisexual)(new BlockPrideBisexual().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideBisexual")
                .setBlockTextureName("PrideBisexual")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideBisexual", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideBisexual extends Block
    {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideBisexualDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideBisexualRight");
