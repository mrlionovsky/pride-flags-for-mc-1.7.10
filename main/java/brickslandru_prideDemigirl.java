...
public class brickslandru_prideDemigirl{

    public brickslandru_prideDemigirl(){}

    public static BlockPrideDemigirl block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideDemigirl");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('3'), new ItemStack(Items.dye, 1, 15),
            Character.valueOf('4'), new ItemStack(Items.dye, 1, 8),
    ...
    static{
        ...
        block = (BlockPrideDemigirl)(new BlockPrideDemigirl().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideDemigirl")
                .setBlockTextureName("PrideDemigirl")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideDemigirl", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideDemigirl extends Block
    {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideDemigirlDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideDemigirlRight");
