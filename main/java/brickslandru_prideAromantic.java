...
public class brickslandru_prideAromantic{

    public brickslandru_prideAromantic(){}

    public static BlockPrideAromantic block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideAromantic");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('2'), new ItemStack(Items.dye, 1, 2),
    ...
    static{
        ...
        block = (BlockPrideAromantic)(new BlockPrideAromantic().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideAromantic")
                .setBlockTextureName("PrideAromantic")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideAromantic", block);
    }

    static class BlockPrideAromantic extends Block
    {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideAromanticDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideAromanticRight");
