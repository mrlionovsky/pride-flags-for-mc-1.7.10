...
public class brickslandru_prideNonbinary{

    public brickslandru_prideNonbinary(){}

    public static BlockPrideNonbinary block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideNonbinary");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('2'), new ItemStack(Items.dye, 1, 11),
            Character.valueOf('3'), new ItemStack(Items.dye, 1, 5),
    ...
    static{
        ...
        block = (BlockPrideNonbinary)(new BlockPrideNonbinary().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideNonbinary")
                .setBlockTextureName("PrideNonbinary")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideNonbinary", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideNonbinary extends Block
    {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideNonbinaryDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideNonbinaryRight");
