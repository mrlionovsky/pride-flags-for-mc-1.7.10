...
public class brickslandru_prideAsexual{

    public brickslandru_prideAsexual(){}

    public static BlockPrideAsexual block;

    public static Object instance;public int addFuel(ItemStack fuel){return 0;}
    public void serverLoad(FMLServerStartingEvent event){}
    public void preInit(FMLPreInitializationEvent event){

        GameRegistry.registerBlock(block, "PrideAsexual");
    }
    ...
    public void load(){
        GameRegistry.addShapedRecipe(new ItemStack(block, 6), new Object[]{
            ...
            Character.valueOf('4'), new ItemStack(Items.dye, 1, 13),
    ...
    static{
        ...
        block = (BlockPrideAsexual)(new BlockPrideAsexual().setHardness(0.1F)
                .setResistance(0.1F)
                .setLightLevel(0.3F)
                .setBlockName("PrideAsexual")
                .setBlockTextureName("PrideAsexual")
                .setStepSound(Block.soundTypeCloth)
                .setCreativeTab(CreativeTabs.tabBlock)
                );
        //;block.setBlockBounds(0.0F,0.0F,0.0F,1.0F,1.0F,1.0F);
        Block.blockRegistry.addObject(183, "PrideAsexual", block);
    }

    public void generateSurface(World world, Random random, int chunkX, int chunkZ){}
    public void generateNether(World world, Random random, int chunkX, int chunkZ){}
    static class BlockPrideAsexual extends Block
    {
        ...
        public void registerBlockIcons(IIconRegister par1IconRegister)
        {
            ...
            this.BlockIconDown = par1IconRegister.registerIcon("PrideAsexualDown");
            this.BlockIconRight = par1IconRegister.registerIcon("PrideAsexualRight");
